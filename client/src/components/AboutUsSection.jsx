...
import AboutSectionImg from '../uitls/images/about-section-img.jpg';
    ...
    <div className="container my-5">
        <div className="flex-column-reverse flex-lg-row row">
            ...
            >
                ...
                <p>Welcome to Flavour Hub Restaurant in Colombo, the perfect experience for special people. Our fancy restaurant will bring your special moments to another level.</p>
